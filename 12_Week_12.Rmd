...
Please simulate the model using the parameter set (_N1_ = 2, _N2_ = 2, _R_ = 0.1, _a1_ = 0.4, _a2_ = 0.6, _e1_ = 1, _e2_ = 1, _d_ = 0.01, _S~0~_ = 0.1) and visualize the population trajectories of the two consumers as well as the resource. 
...
<div style="margin-left: 30%;">$\begin{align}\frac {dN_{1}}{dt} = e_{1}a_{1a}R_{a}N_{1}+e_{1}a_{1b}R_{b}N_{1}-dN_{1}\end{align}\\$</div>
<div style="margin-left: 30%;">$\begin{align}\frac {dN_{2}}{dt} = e_{2}a_{2a}R_{a}N_{2}+e_{2}a_{2b}R_{b}N_{2}-dN_{2}\end{align}\\$</div>
<div style="margin-left: 30%; margin-bottom: 15px;">$\begin{align}\frac {dR_{a}}{dt} = d(S_{a}-R_{a})-a_{1a}R_{a}N_{1}-a_{2a}R_{a}N_{2}\end{align}$</div>
<div style="margin-left: 30%; margin-bottom: 15px;">$\begin{align}\frac {dR_{b}}{dt} = d(S_{b}-R_{b})-a_{1b}R_{b}N_{1}-a_{2b}R_{b}N_{2}\end{align}$</div>
...
<div style="margin-left: 30%; margin-bottom: 15px;">$\begin{align}\frac {dR}{dt} = rR(1-\frac{R}{K})-a_{1}RN_{1}-\frac{a_{2}R}{k_{2}+R}N_{2}\end{align}$</div>
