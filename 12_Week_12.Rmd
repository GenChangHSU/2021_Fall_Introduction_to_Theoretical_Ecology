...
<div style="margin-left: 30%; margin-bottom: 10px;">$\begin{align}\frac {dR}{dt} = d(S_{0}-R)-a_{1}RN_{1}-a_{2}RN_{2}\end{align}$</div>

Please simulate the model using the parameter set (_N1_ = 2, _N2_ = 2, _R_ = 0.1, _a1_ = 0.4, _a2_ = 0.6, _e_ = 1, _d_ = 0.01, _S~0~_ = 0.1) and plot the population trajectories of the two consumers and the resource.
