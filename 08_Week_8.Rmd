...
summary_dat <- tibble(` ` = c("$\\frac {\\alpha_{AA}}{r_{A}} - \\frac {\\alpha_{BA}}{r_{B}}$", ""),
                      ...
                      `$-$` = c("$\\bullet$ $E_{A}$ unstable and $E_{B}$ stable <br> $\\bullet$ $E_{AB}$ unfeasible <br> $\\bullet$ $IGR_{A}$ < 0 and $IGR_{B}$ > 0 <br> $\\bullet$ Species B wins", "$\\bullet$ $E_{A}$ and $E_{B}$ unstable <br> $\\bullet$ $E_{AB}$ feasible but unstable <br> $\\bullet$ $IGR_{A}$ < 0 and $IGR_{B}$ < 0 <br> $\\bullet$ Priority effect"))
...
kbl(summary_dat, align = "ccll", escape = F) %>%
  ...
  row_spec(2, extra_css = "border-color: white; background-color: white") %>%
  column_spec(1, width = "3em", extra_css = "font-size: 25px; border-color: white; position: relative; top: 0%;") %>%
  column_spec(2, width = "3em", extra_css = "font-size: 30px; border-color: white; font-weight: bold; vertical-align: middle") %>%
