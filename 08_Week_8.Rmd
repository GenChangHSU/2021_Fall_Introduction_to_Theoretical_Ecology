...
summary_dat <- tibble(`1` = c("a1-b1", ""),
                      `2` = c("+", "-"),
                      `+` = c("EA and EB unstable <br> EAB feasible and stable <br> IGRA > 0 and IGRB > 0 <br> Stable coexistence", "EA stable and EB unstable <br> EAB unfeasible <br> IGRA > 0 and IGRB < 0 <br> Species A wins"), 
                      `-` = c("EA unstable and EB stable <br> EAB unfeasible <br> IGRA < 0 and IGRB > 0 <br> Species B wins", "EA and EB unstable <br> EAB feasible but unstable <br> IGRA < 0 and IGRB < 0 <br> Priority effect"))

kbl(summary_dat, align = "cccc", escape = F) %>%  
