...
\hypertarget{lecture-in-a-nut-shell}{%
\section{Lecture in a nut shell}\label{lecture-in-a-nut-shell}}
...
\hypertarget{lecture-in-a-nut-shell-1}{%
\section{Lecture in a nut shell}\label{lecture-in-a-nut-shell-1}}
