...
\hypertarget{week2lab}{%
\section*{Lab demonstration}\label{week2lab}}
\addcontentsline{toc}{section}{Lab demonstration}
...
\textbf{\emph{Age-structured population models}}
...
\begin{center}\includegraphics[width=0.95\linewidth]{04_Week_4_files/figure-latex/unnamed-chunk-2-1} \end{center}

\url{http://raven.wrrb.uaf.edu/~ntakebay/teaching/programming/logistic/node1.html}

\url{http://equation-of-the-month.blogspot.com/2012/01/logistic-growth.html}
